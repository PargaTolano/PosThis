...
-- Query para creacion de tablas base de datos [db_a74ca4_pargatolano]
-- Query Creado el 2021-05-23 por José Antonio Parga Tolano
-- Solo utilzar para crear, no puedes dar drop desde una conexion que no este en smarterasp.net
-- cambiar el nombre de la base de datos por uno que exista en el host si se requiere
-- nombre actual db_a74ca4_pargatolano

USE db_a74ca4_pargatolano;
